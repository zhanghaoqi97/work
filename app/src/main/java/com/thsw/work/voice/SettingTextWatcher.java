...
public class SettingTextWatcher implements TextWatcher {
	...
	public SettingTextWatcher(Context context, EditTextPreference e, int min,
			int max) {
		mContext = context;
	...
	public void onTextChanged(CharSequence s, int start, int before, int count) {
		// Log.e("demo",
		// "onTextChanged start:"+start+" count:"+count+" before:"+before);
		editStart = start;
		editCount = count;
	}
	...
	public void beforeTextChanged(CharSequence s, int start, int count,
			int after) {
		// Log.e("demo",
		// "beforeTextChanged start:"+start+" count:"+count+" after:"+after);
	}
